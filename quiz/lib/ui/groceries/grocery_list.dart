...
import 'package:quiz/ui/groceries/search.dart';
...
enum GroceryListViewTab { groceries, search }

class _GroceryListState extends State<GroceryList> {
  GroceryListViewTab _currentTab = GroceryListViewTab.groceries;
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        onTap: (index) {
          setState(() {
            _currentTab = GroceryListViewTab.values[index];
          });
        },
        items: const [
